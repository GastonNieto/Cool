...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    JSONObject jso;
    Double longitudOrigen, latitudOrigen , latitud = 2.942043, longitud =-75.2522789;
        ...
        map.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                if (actualPosition){
                    ...
                    String url ="https://maps.googleapis.com/maps/api/directions/json?origin=-29.3906752,-66.8267126&destination=2.9435667,-75.2458577&key=AIzaSyBrZ907JVP4j6rNPCt6O7RIQwpy8g5rQBI";
